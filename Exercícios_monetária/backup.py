...
fig,ax = plt.subplots()
ax.plot(series_df[['acumulado - 433','Metas inflação','Limite superior','Limite inferior']])
ax.legend(('IPCA acumulado 12 meses','Meta','Limite superior','Limite inferior'))
fig.autofmt_xdate()
...
plt.grid(True)
fig.savefig('ipca com limites e meta',dpi=600)
plt.show()
